...
import {
  INFO,
  ERROR,
} from "../../components/common/MessageIndicator/constants"

import styles from "../../public/css/dashboard/account.module.css"

export default function DashboardAccountPage() {
  const auth = useAuth()
  const firestore = useFirestore()
  const { dispatch } = useDashboardContext()
  const [dataState, dataDispatch]: [{[key: string]: any}, Dispatch<any>] = useReducer(reducer, {
            ...
            <DashboardActionButton
              onClick={() => {
                auth.setUserProfile(
                  ...
                  undefined, 
                  (success) => flashMessage(dispatch, success.message, INFO, 2000),
