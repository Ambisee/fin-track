  ...
  public: {
    ...
    Functions: {
      calculate_statistics: {
        Args: { p_end_ts: string; p_ledger_id: number; p_start_ts: string }
        Returns: {
          category: string
          created_by: string
          end: string
      ...
      create_default_categories: { Args: { new: unknown }; Returns: undefined }
      create_initial_ledger: { Args: { new: unknown }; Returns: undefined }
      create_settings: { Args: { new: unknown }; Returns: undefined }
      search_entry: {
        Args: { query: string }
        Returns: {
          amount: number
